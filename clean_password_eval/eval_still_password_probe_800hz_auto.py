...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate workstation 800Hz still-password-still probe with native 800Hz Stage1/2/3 auto pipeline.")
    ...
    parser.add_argument("--output-dir", default="results/800hz_stage12_baseline/still_probe_auto_eval_20260401")
