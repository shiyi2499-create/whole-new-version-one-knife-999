...
Re-exported from stage2_open — identical logic.
"""
# This is a re-export. The actual loader code lives in stage2_open/data/loaders.py
# and is identical. We keep a local copy for package independence.
...
class SessionLoader:
    ...
    def extract_attempt_segments(self):
        """Returns list of attempt segments with IMU, onsets, chars."""
        ts, imu = self.get_imu()
